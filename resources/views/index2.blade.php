...
<head>
    ...
    <style>
        body.cams-dashboard-shell {
            min-height: 100vh;
            overflow: hidden;
            background: #f5f8fb;
        }

        body.cams-dashboard-shell #main-wrapper {
            min-height: 100vh;
            height: 100vh;
            overflow: hidden;
        }

        body.cams-dashboard-shell .page-wrapper {
            min-height: 100vh;
            height: 100vh;
            display: flex;
        ...
        body.cams-dashboard-shell .topbar {
            position: sticky;
            top: 0;
            flex: 0 0 auto;
            z-index: 1030;
        ...
        body.cams-dashboard-shell .body-wrapper {
            flex: 1 1 auto;
            min-height: 0;
            overflow-y: auto;
            overflow-x: hidden;
        ...
        body.cams-dashboard-shell .body-wrapper > .container-fluid {
            max-width: 100%;
            padding-bottom: 1.25rem;
        }

        body.cams-dashboard-shell .dash-footer,
        body.cams-dashboard-shell .footer,
        body.cams-dashboard-shell footer {
...
<body class="cams-dashboard-shell">
    <!-- Preloader -->
    {{-- <div class="preloader">
