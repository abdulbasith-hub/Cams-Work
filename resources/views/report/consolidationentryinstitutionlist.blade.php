...
@section('title', 'Consolidation Entry Institution List')
@section('content')
@php
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 text-end d-flex align-items-center justify-content-end">
                        <div class="alert-info mt-2 p-2">
                            ...
                            <strong>Note:</strong> Select "View" to view the paras for that institution.
                        </div>
                    </div>
                </div>
                <div class="row mt-3">
                    <div class="col-12">
                        <div class="table-responsive">
                            <table id="institutionsTable"
                                class="table table-striped table-bordered table-hover datatables-basic" style='overflow:auto; width:100%;position:relative;'>
                                <thead>
                                    <tr>
                                        <th rowspan="2" class="text-center">S.No</th>
                                        <th rowspan="2" class="text-center">Region / District</th>
                                        <th rowspan="2" class="text-center">Institution</th>
                                        ...
                                        <th rowspan="2" class="text-center">Total Paras</th>
...
<script>
    ...
    function displayInstitutionsTable(institutions) {
        ...
        institutions.forEach((institution, index) => {
            ...
            const isForwarded = institution.is_forwarded > 0;
        ...
        institutionsDataTable = $('#institutionsTable').DataTable({
            ...
            columns: [
			    ...
			    auditplanid: row.auditplanid,
                        ...
                        return `<form method="GET" action="{{ route('consolidation.entry.details') }}" style="display:inline;">
