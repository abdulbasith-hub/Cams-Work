    ...
    <div id="pageWrapper">
        <div class="phStickyWrap font_div">
            ...
            <!-- Right side: Login link -->
                            <div class="col-12 col-md-4 d-flex justify-content-end align-items-center mt-3 mt-md-0" style="gap: 10px; flex-wrap: wrap;">
                                <a href="{{ route('dga.home') }}" class="dga-home-button">DGA</a>
                    			...
                    			<li><a class="dropdown-item lang" key="auditeeinstlogin" href="{{ url('/auditeeinstlogin') }}">Auditee HOD Login</a></li>
