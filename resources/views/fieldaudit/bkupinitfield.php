...
<div class="row">
    ...
    @endif</td>
        ...
        href="{{ route('audit_slip', ['id' => $item->encrypted_auditscheduleid, 'instid' => $item->instid, 'spilloverflag' => $item->spilloverflag]) }}">
    ...
    <a id="prf_auditshowbtn{{ $index }}"
					...
					<input type="hidden" id="inlogschedulestatus{{ $index }}" value="{{ $item->inlogschedulestatus }}">
...
<script>
 ...
 function entrymeetingPopup(auditschid,entrymeetdate,formatted_fromdate,auditteamhead,dataindex,spillover, exitmeetstatus,inlogschedulestatus, auditmode, performance_auditdet)
    {
    ...
    $(document).on('click', '.showexitmeet', function(event) 
     {
        ...
        exitmeetingPopup(scheduleId,exitMeetDate,entryMeetDate,'',auditteamhead,dataindex,auditmode)
...
///////////////////////////////////////////////End///////////////////////////////////////////////////////////////
    ...
    function exitmeetingPopup(auditschid,exitmeetdate,entrymeetdate,showtype='',auditteamhead,dataindex,onchange,auditplanid,auditmode)
    {
...
let tableHtml = `
	...
	var inlogschedulestatus = $('#inlogschedulestatus' + dataindex + '').val();
        $('.indexdyn').val(dataindex);
        entrymeetingPopup(scheduleId,entryMeetDate,Fromdate,auditteamhead,dataindex,spillover, exitmeetstatus,inlogschedulestatus, auditmode, performance_auditdet)
            ...
            $('#from_date-error').hide();
             if (auditmode == 'P') {
                    ...
                    if (prf_filedetails && prf_filedetails !== '-') {
                        ...
                        var fileUrl = '/storage/' + filepath; // adjust base path if needed
