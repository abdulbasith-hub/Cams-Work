@section('content')
    ...
    if (count($instdel)) {
        ...
        $spillover = $instdel[0]['spilloverflag'];
...
if (count($instdel)) { ?>
    ...
    <div class="row mb-3">
        <div class="col-12 d-flex justify-content-center">
            <div class="d-flex align-items-center">
                ...
                <label class="form-label me-2 mb-0 fw-bold">Quarter :</label>

                <select class="form-select w-auto" id="auditschedule_select" onchange="fitthescheduledel()"
                    style="min-width:120px;">

                    <?php foreach ($instdel as $key => $row) { ?>
                    <option value="<?php echo $row['auditscheduleid']; ?>" <?php echo $key == 0 ? 'selected' : ''; ?>>
                        <?php echo $row['auditquartercode']; ?>
                    </option>
                    <?php } ?>
                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-md-2 mb-3">
                                    ...
                                    <input type="text" class="form-control" id="typeofauditname" name="typeofauditname"
                                ...
                                @if ($instdel[0]['deptcode'] == '01' && $instdel[0]['annadhanam_only'] == 'Y')
                                    <div class="col-md-2 mb-3"> <label class="form-label required"
                                            ...
                                            class="form-control" id="annadhanamyear" name="annadhanamyear"
                                ...
                                <div class="col-md-2 mb-3">
                                    ...
                                    <input type="text" class="form-control" id="teamheadname" name="teamheadname"
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-11">
                            ...
                            <div class="card" style="border-color: #7198b9">
                                ...
                                <div class="card-body">
                                    <div id="auditslipcard" class="hide_this">
                                    ...
                                    <div id="viewauditslipcard" class="hide_this">
                                        ...
                                        <div class="row mt-2">
                                            ...
                                            <div class="col-md-4">
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-7" id="schemenamediv">
                                                        <label class="form-label lang" key="schemename"
                                                            for="validationDefaultUsername">Scheme
                                                            Name</label>
                                            ...
                                            <div class="col-md-2">
                                                <label class="form-label lang" key="serious"
                                                    for="validationDefaultUsername">Irregularities</label>
                                            ...
                                            <div class="col-md-4">
                                                <label class="form-label lang" key="if_subcategory"
                                                    for="validationDefaultUsername">Sub
                                                    Category</label>
    ...
    <script>
        var instdel = <?php echo json_encode($instdel); ?>;

        function fitthescheduledel() {

            var auditscheduleid = $('#auditschedule_select').val();


            var selected = instdel.find(function(item) {
                return item.auditscheduleid == auditscheduleid;
            });

            if (selected) {

                $('#typeofauditname').val(selected.typeofauditename);
                $('#yearname').val(selected.yearname);
                $('#teamheadname').val(selected.username);
                $('#annadhanamyear').val(selected.annadhanamyear);
        ...
        function getauditslip(slipid, action, fixid, filter) {
            $.ajax({
                ...
                data: {
                    auditslipid: slipid,
                    auditscheduleid: $('#auditschedule_select').val(),
                    action: action,
                    filter: filter,
                    spilloverflag: '<?php echo $spillover; ?>',
                    ...
                    if (response.success) {
                        ...
                        if ((((action == 'fetch') || (action == 'fetchwithdata')) && response.data.auditDetails
                            ...
                            if (firstItem) {
                                ...
                                show_view_card(response.data.historydel[0]);
                            }
                            ...
                            set_auditeereplyform(response.data.historydel[0])
                            appendFilePreview();
			...
			<div class="d-flex flex-column w-100">
				...
				<div class="d-none d-md-flex align-items-center w-100">
					<div class="text-truncate">
						<b>${forwardedby} ${ data.forwardedbyusertypecode === 'A' ? `Observation` : "Reply"}</b>
					</div>
