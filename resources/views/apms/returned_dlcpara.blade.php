...
@section('content')
    ...
    <div class="col-12">
        ...
        <div class="card mt-2" style="border-color: #7198b9">
            <div class="card-header card_header_color lang" key="">Returned DLC Para Details</div>
            <div class="card-body">
    ...
    <script>
                ...
                columns: [{
                    ...
                    },
                    {
                        ...
                        render: function(data, type, row, meta) {
                            ...
                            let url = row.encrypted_apms_hlcid ?
                                "{{ url('init_paramanegement_hlc') }}/" + row.encrypted_apms_hlcid :
                                "{{ route('init_paramanegement_hlc') }}";
        ...
        function fetch_init_dlcparas(language) {
            ...
            $.ajax({
                url: '/apms/fetch_returned_dlcparas', // For creating a new user or updating an existing one
                type: 'POST',
                headers: {
