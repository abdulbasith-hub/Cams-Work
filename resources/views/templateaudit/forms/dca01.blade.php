...
<div class="my-4">
    @foreach ($templatesData as $templateData)
        ...
        @if ($structure && $structure->deptcode === '04' && $structure->formcode === 'DCA01')
            <form id="dcaForm" action="{{ route('templateaudit.dca_insertUpdate') }}" method="POST"
                    ...
                    <div class="audit-form">
                        ...
                        <div id="template-content">
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-md-6 col-lg-4">
                                    <label class="form-label lang" key=""></label>
                                    <div class="auto-field" data-english="Audit Certificate for Credit Societies(Model)"
                                        data-tamil="கடன் கூட்டுறவு சங்கங்களுக்கான தணிக்கை சான்றிதழ்">
                                        Audit Certificate for Credit Societies(Model)<br>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6 col-lg-4">
                                    ...
                                    <div class="auto-field"
                                        ...
                                        data-tamil="சங்கங்களின் சுய விவரம்(கடன்)">
                                        Progressive Profile of the Institutions(Credit)<br>
                                    </div>
                                </div>
...
<script>
    ...
    function formatRemarksBeforeSubmit() {
        ...
        remarksData.forEach((remark, index) => {
            ...
            document.getElementById('dcaForm').appendChild(typeInput);

            const textInput = document.createElement('input');
            textInput.type = 'hidden';
            textInput.name = `remarks[${index}][text]`;
            textInput.value = remark.text;
            document.getElementById('dcaForm').appendChild(textInput);
        });
    }
    ...
    function formatDecimalInput(field) {
        ...
        if (parseInt(temptypeid) === 1 && parseInt(subtemptypeid) === 1) {
    ...
    function formatDecimalValue(field) {
        ...
        if (temptypeid === 1 && subtemptypeid === 1 && (fieldType === 'text' || fieldType === 'number')) {
    ...
    function getBalanceSheetValues() {
        const currentYearNetProfit = parseFloat(
            document.querySelector('input[data-maintypeid="107"][data-subtypeid="21"].current-year-input')
            ?.value || 0
        );
        const previousYearNetProfit = parseFloat(
            document.querySelector('input[data-maintypeid="65"][data-subtypeid="13"].previous-year-input')
            ?.value || 0
        );
        const currentYearNetLoss = parseFloat(
            document.querySelector('input[data-maintypeid="108"][data-subtypeid="23"].current-year-input')
            ?.value || 0
        );
        const previousYearNetLoss = parseFloat(
            document.querySelector('input[data-maintypeid="97"][data-subtypeid="18"].previous-year-input')
            ?.value || 0
        );
    ...
    function updateStatementIIIA(currentYearNetProfit, currentYearNetLoss, previousYearNetLoss) {
        const statementIIIAFields = {
            ...
            netProfitBroughtForward: document.querySelector(
                'input[data-maintypeid="109"][data-subtypeid="27"].current-year-input'),
            netLossEndOfYear: document.querySelector(
                'input[data-maintypeid="109"][data-subtypeid="28"].current-year-input'),
    ...
    function calculatePreviousYearStatementIIIA() {
        const previousYearFields = {
            ...
            netProfitBroughtForward: document.querySelector(
                'input[data-maintypeid="109"][data-subtypeid="27"].previous-year-input'),
            netLossEndOfYear: document.querySelector(
                'input[data-maintypeid="109"][data-subtypeid="28"].previous-year-input'),
            totalNetLoss: document.querySelector(
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        if (finalizeBtn && !isFinalMode) {
            finalizeBtn.addEventListener('click', function(e) {
                ...
                const validator = $('#dcaForm').validate();
