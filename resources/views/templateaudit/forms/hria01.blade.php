...
<div class="my-4">
    @foreach ($templatesData as $templateData)
        ...
        @if ($structure && $structure->deptcode === '01' && $structure->formcode === 'HRIA01')
            <form id="hriaOkpForm" action="{{ route('templateaudit.insertUpdate') }}" method="POST"
                enctype="multipart/form-data">
                <div class="card" style="border-color: #7198b9">
                    <div class="card-header card_header_color lang" data-english="Template Audit Details - HRIA"
                        ...
                        <div id="template-content">
                            <div class="row g-3">
                                <div class="col-md-6 col-lg-6">
                                    <label class="form-label lang" data-english="Institution Name and Address"
                                ...
                                <div class="col-md-6 col-lg-2">
                                    <label class="form-label lang" data-english="Reference Number"
                                        data-tamil="குறிப்பு எண்">
                                        Reference Number
                                    </label>
                                ...
                                <div class="col-md-6 col-lg-3">
                                    <label class="form-label lang" data-english="Auditor Name"
                                ...
                                @if (!empty($basicinformation->zoneename))
                                    <div class="col-md-6 col-lg-3">
                                        <label class="form-label lang" data-english="Assistant Commissioner Zone"
                                ...
                                @if (!empty($basicinformation->circleename))
                                    <div class="col-md-6 col-lg-3">
                                        <label class="form-label lang" data-english="Inspector Circle"
                                ...
                                <div class="col-md-6 col-lg-3">
                                    <label class="form-label lang required" data-english="Audit Year"
                                    ...
                                    <select name="yearselected[]" id="yearselected"
                                        ...
                                        <option value="" disabled data-english="Select Year"
                                            data-tamil="ஆண்டைத் தேர்ந்தெடுக்கவும்">Select Year</option>
                            ...
                            <div class="row g-3">
                                <div class="col-md-4">
                                    <label for="priest_name" class="form-label lang required"
                                        data-english="Priest/Poojari Name" data-tamil="பூசாரி பெயர்">
                                        Priest/Poojari Name
                                    </label>
                                    <input type="text" class="form-control lang" id="priest_name" name="priest_name"
                                ...
                                <div class="col-md-4">
                                    <label for="phone_number" class="form-label lang required"
                                        data-english="Phone Number" data-tamil="தொலைபேசி எண்">
                                        Phone Number
                                    </label>
                                    <input type="tel" class="form-control lang" id="phone_number"
                                        name="phone_number" placeholder="Enter Phone number" required maxlength="10"
                               ...
                               <div class="col-md-4">
                                ...
                                <div class="col-md-4">
                                    <label for="branch_name" class="form-label lang required"
                                        data-english="Branch Name" data-tamil="கிளை பெயர்">
                                        Branch Name
                                    </label>
                                    <input type="text" class="form-control lang" id="branch_name"
                                        name="branch_name" placeholder="Enter Branch name" required maxlength="60"
                                        pattern="^[A-Za-z .'\-]{1,60}$"
                                ...
                                <div class="col-md-4">
                                    <label for="account_number" class="form-label lang required"
                                        data-english="Account Number" data-tamil="கணக்கு எண்">
                                        Account Number
                                    </label>
                                    <input type="text" class="form-control lang" id="account_number"
 				 ...
 				 {{-- <div class="col-md-4">
                            ...
                            <div class="table-responsive">
                                <h4 class="section-title lang" data-english="Audit Details"
                                            ...
                                            <tr>
                                                @foreach ($pairs as $pairIndex => $pair)
                                                    @php
                                                        ...
                                                        // Safe way to get className with null checks
                                                        $className = 'default-input'; // default value
                                                        if (
                                                            isset($pair['category']) &&
                                                            isset($pair['category']['lblename'])
                                                        ) {
                                                            $className =
                                                                strtolower(
                                                                    preg_replace(
                                                        ...
                                                        // Safe way to check if required
                                                        $isRequired = true; // default to required for safety
                                                        if ($item && isset($item['maintypetotalflag'])) {
                                                            $isRequired =
                                                        ...
                                                        // Get value safely
                                                        $value = '';
                                                        if ($item && isset($amountValues[$item['maintypeid']])) {
                                                            $value = $amountValues[$item['maintypeid']];
                                                            if (($item['temptypeid'] ?? null) == 1 && $value !== '') {
                                                        ...
                                                        @if ($item && !empty($item['maintypeid']))
                                                            ...
                                                            @if ($inputType === 'radio')
                                                                    ...
                                                                    @foreach ($radioOptions as $option)
                                                                        ...
                                                                        <div class="form-check">
                                                                            <input type="radio"
                                                                                ...
                                                                                id="{{ $radioId }}"
                                                                                name="amount[pair{{ $pairIndex }}][{{ $item['maintypeid'] }}]"
                                                                                value="{{ $optionValue }}"
                                                                                {{ $isChecked ? 'checked' : '' }}
                                                                            ...
                                                                            <label class="form-check-label lang"
                                                                                for="{{ $radioId }}"
                                                                                data-english="{{ $option }}"
                                                                                data-tamil="{{ $option === 'Yes' ? 'ஆம்' : 'இல்லை' }}">
                                                                                {{ $option }}
                                                                            </label>
                                                                        </div>
                                                                    @endforeach
                                                                ...
                                                                @if ($isRequired && !$isFinalMode)
                                                                    <div class="invalid-feedback lang"
                                                                        data-english="Please select an option."
                                                                        data-tamil="ஒரு விருப்பத்தைத் தேர்ந்தெடுக்கவும்.">
                                                            ...
                                                            @else
                                                                <input type="{{ $inputType }}"
                                                                    ...
                                                                    data-temptypeid="{{ $item['temptypeid'] ?? 2 }}"
                                                                    name="amount[pair{{ $pairIndex }}][{{ $pair['category']['tmpauditheaderid'] ?? '' }}][{{ $item['maintypeid'] }}]"
                                                                    @if ((!empty($item['maintypetotalflag']) && $item['maintypetotalflag'] !== 'O') || $isFinalMode) readonly @endif
                                                                    ...
                                                                    value="{{ $value }}"
                                                                    @if ($inputType === 'number') inputmode="decimal" @endif>
                                                            @endif
                                    ...
                                    @if ($isFinalMode)
                                        <div class="form-control bg-light"
                                            ...
                                            @if (!empty($existingRemarks))
                                                ...
                                                @endforeach
                                            @else
                                                <span class="lang" data-english="No remarks"
                                                    data-tamil="கருத்துகள் இல்லை">No remarks</span>
                                            @endif
                                        </div>
                                    @else
                                ...
                                <div id="auditcertificateDiv" class="hideotherdiv">
                                    ...
                                    <div class="row mb-3 align-items-start">
                                        <div class="col-md-2 text-dark">
                                            <b class="lang" data-english="Type of Certificate"
                                                data-tamil="சான்றிதழ் வகை">
                                                Type of Certificate
                                            </b>
                                        </div>
                            ...
                            <div class="d-flex justify-content-center mt-4 no-print">
                                {{-- @if (!$isFinalMode)
                                    <button class="btn btn-primary me-2" type="submit" id="save-button">
                                        ...
                                        <span class="lang" data-english="Save Draft"
                                            data-tamil="வரைவைச் சேமிக்கவும்">Save Draft</span>
                                    </button>
                                @endif
                                ...
                                @if ($isEditMode)
                                    <button class="btn btn-success me-2" type="button" id="finalize-button">
                                        ...
                                        <span class="lang" data-english="Finalize"
                                            data-tamil="இறுதிசெய்">Finalize</span>
                                    </button>
                                @endif --}}
                        ...
                        <div class="modal-dialog modal-xl" style="max-width:40%;">
                            <div class="modal-content">
                                ...
                                <div class="modal-footer justify-content-center">
                                    <button id="downloadReportBtn" data-catcode ="{{ $catcode }}"
...
<script>
    ...
    function formatRemarksBeforeSubmit() {
        ...
        remarksData.forEach((remark, index) => {
            ...
            document.getElementById('hriaOkpForm').appendChild(typeInput);

            const textInput = document.createElement('input');
            textInput.type = 'hidden';
            textInput.name = `remarks[${index}][text]`;
            textInput.value = remark.text;
            document.getElementById('hriaOkpForm').appendChild(textInput);
        });
    }
    ...
    function calculate() {
        ...
        allInputs.forEach(el => {
            ...
            // Only process numeric fields (temptypeid = 1) for calculations
            if (temptypeid === 1) {
                ...
                if (!el.readOnly) {
                    if (type === 'O') {
                        openingVal = value;
                    } else if (type && type.includes('T')) {
                        // Skip total fields
                    } else if (el.classList.contains('receipts-input')) {
                        totalIncome += value;
        ...
        const A = totalIncome;
        const C = totalExpense;
        const B = A + openingVal;
        const closing = B - C;

        const setVal = (selector, val) => {
            const el = document.querySelector(selector);
            if (el && parseInt(el.dataset.temptypeid) === 1) { // Only set numeric fields
                el.value = val.toFixed(2);
            }
        };

        setVal('[data-type="R"]', A);
        setVal('[data-type="E"]', C);
        setVal('[data-type="V"]', B);
        setVal('[data-type="X"]', B);
        setVal('[data-type="C"]', closing);
    }
    ...
    function initializeFormValidation() {
        ...
        //     return this.optional(element) || /^[A-Z]{4}[A-Z0-9]{7}$/.test(value.replace(/\s/g, ''));
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        if (finalizeBtn && !isFinalMode) {
            finalizeBtn.addEventListener('click', function(e) {
                ...
                const validator = $('#hriaOkpForm').validate();
                    ...
                    function() {
                        ...
                        if (!$('input[name="finalize"]').length) {
                            $('<input>').attr({
                                ...
                                name: 'finalize',
                                value: '1'
                            }).appendTo('#hriaOkpForm');
                        }

                        $('#hriaOkpForm').trigger('submit');
