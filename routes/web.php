...
Route::post('/auditor/login-epacs', [App\Http\Controllers\APIController::class, 'epacslogin'])
    ->name('auditor.login.epacs');
...
Route::get('/dga', [App\Http\Controllers\DgaController::class, 'index'])->name('dga.home');
Route::get('/dga/departments/{slug}', [App\Http\Controllers\DgaController::class, 'department'])
    ->whereIn('slug', ['lfa', 'sgad', 'hria', 'dca', 'milk'])
    ->name('dga.department');
...
Route::middleware('check.session')->group(function () {
    ...
    Route::prefix('newhelpdesk')->name('fresh-helpdesk.')->group(function () {
	        Route::get('/', [App\Http\Controllers\FreshHelpdeskController::class, 'index'])->name('index');
	        Route::get('/dashboard', [App\Http\Controllers\FreshHelpdeskController::class, 'dashboard'])->name('dashboard');
	        Route::post('/dashboard', [App\Http\Controllers\FreshHelpdeskController::class, 'dashboardState'])->name('dashboard.state');
	        Route::get('/dashboard/developer-summary', [App\Http\Controllers\FreshHelpdeskController::class, 'dashboardDeveloperSummary'])->name('dashboard.developer-summary');
	        Route::get('/dashboard/pane-summary', [App\Http\Controllers\FreshHelpdeskController::class, 'dashboardPaneSummary'])->name('dashboard.pane-summary');
	        Route::post('/dashboard/important-tickets/verify', [App\Http\Controllers\FreshHelpdeskController::class, 'dashboardVerifyImportantTickets'])->name('dashboard.important-tickets.verify');
	        Route::post('/tickets/auto-forward-check', [App\Http\Controllers\FreshHelpdeskController::class, 'autoForwardStaleNicTickets'])->name('tickets.auto-forward-check');
	        Route::get('/createticket', [App\Http\Controllers\FreshHelpdeskController::class, 'create'])->name('create');
	        Route::get('/ticketdetails', [App\Http\Controllers\FreshHelpdeskController::class, 'ticketDetails'])->name('ticket-details');
	        Route::post('/ticketdetails', [App\Http\Controllers\FreshHelpdeskController::class, 'ticketDetailsFilter'])->name('ticket-details.filter');
	        Route::get('/categorymaster', [App\Http\Controllers\FreshHelpdeskController::class, 'categoryMaster'])->name('category-master');
        Route::post('/categorymaster', [App\Http\Controllers\FreshHelpdeskController::class, 'storeCategory'])->name('category-master.store');
        Route::post('/tickets', [App\Http\Controllers\FreshHelpdeskController::class, 'storeTicket'])->name('tickets.store');
        Route::post('/tickets/{ticket}/actions/{action}', [App\Http\Controllers\FreshHelpdeskController::class, 'ticketAction'])
            ->whereNumber('ticket')
            ->where('action', '[A-Za-z0-9_]+')
            ->name('tickets.action');
        Route::get('/tasks', [App\Http\Controllers\FreshHelpdeskController::class, 'tasks'])->name('tasks.index');
        Route::get('/assigntask', [App\Http\Controllers\FreshHelpdeskController::class, 'assignTask'])->name('assign-task');
        Route::get('/taskdetails', [App\Http\Controllers\FreshHelpdeskController::class, 'taskDetails'])->name('task-details');
        Route::post('/taskdetails', [App\Http\Controllers\FreshHelpdeskController::class, 'taskDetailsFilter'])->name('task-details.filter');
        Route::post('/tasks', [App\Http\Controllers\FreshHelpdeskController::class, 'storeTask'])->name('tasks.store');
        Route::post('/tasks/{task}/actions/{action}', [App\Http\Controllers\FreshHelpdeskController::class, 'taskAction'])
            ->whereNumber('task')
            ->where('action', '[A-Za-z0-9_]+')
            ->name('tasks.action');
    });
    ...
    // ----------------- Performance Report ------------------------------------------------------------------
    Route::get('/prauditreport', [App\Http\Controllers\PerformanceController::class, 'prauditreport'])->name('Performance.prauditreport');
    Route::post('/getaudittitles', [App\Http\Controllers\PerformanceController::class, 'getPerformanceAuditTitles'])->name('Performance.getaudittitles');
    Route::post('/getpreportaudittitles', [App\Http\Controllers\PerformanceController::class, 'getPerformancereportAuditTitles'])->name('Performance.getpreportaudittitles');
    Route::post('/getauditsummary', [App\Http\Controllers\PerformanceController::class, 'getPerformanceAuditSummary'])->name('Performance.getauditsummary');
    Route::post('/getinstitutionsforaudit', [App\Http\Controllers\PerformanceController::class, 'getPerformanceAuditInstitutions'])->name('Performance.getinstitutionsforaudit');
    Route::post('/getinstitutionremarks', [App\Http\Controllers\PerformanceController::class, 'getinstitutionremarksforpraudit'])->name('Performance.getinstitutionremarks');
    Route::post('/saveinstitutionremarks', [App\Http\Controllers\PerformanceController::class, 'savePerformanceAuditRemarks'])->name('Performance.saveinstitutionremarks');
    Route::post('get-praudit-report-remarks', [PerformanceController::class, 'getPrauditReportRemarks'])->name('Performance.getPrauditReportRemarks');
    Route::post('/verifyinstitution', [App\Http\Controllers\PerformanceController::class, 'verifyInstitutionReport'])->name('Performance.verifyinstitution');
    Route::post('/getverifiedinstitutions', [App\Http\Controllers\PerformanceController::class, 'getVerifiedInstitutions'])->name('Performance.getverifiedinstitutions');
    Route::post('check-verification-status', [App\Http\Controllers\PerformanceController::class, 'checkVerificationStatus'])->name('Performance.checkVerificationStatus');
    Route::post('finalize-report', [App\Http\Controllers\PerformanceController::class, 'finalizeReport'])->name('Performance.finalizeReport');
    Route::post('get-title-finalization-status', [App\Http\Controllers\PerformanceController::class, 'getTitleFinalizationStatus'])->name('Performance.getTitleFinalizationStatus');
    Route::get('listprauditreport', [App\Http\Controllers\PerformanceController::class, 'view_prauditconsolidation'])->name('Performance.view_prauditconsolidation');
    Route::post('getprconsolidationreport', [App\Http\Controllers\PerformanceController::class, 'getconsolidationprauidtreport'])->name('Performance.getconsolidationprauidtreport');
    Route::get('/performance_audit_consolidation/{praudittitleid}/{deptcode}/{catcode}/{subcatid}/{finyear}', [App\Http\Controllers\PerformanceController::class, 'showFindingsRecommendations'])->name('performance.findingsRecommendations');
    Route::post('performance/clear-section-file', [App\Http\Controllers\PerformanceController::class, 'clearSectionFile'])->name('performance.clearSectionFile');
    Route::post('performance/upload-section-file', [App\Http\Controllers\PerformanceController::class, 'uploadSectionFile'])->name('performance.uploadSectionFile');
    Route::post('performance/delete-section-file', [App\Http\Controllers\PerformanceController::class, 'deleteSectionFile'])->name('performance.deleteSectionFile');

    Route::post('performance/generate-report', [App\Http\Controllers\PerformanceController::class, 'generatePerformanceReport'])->name('performance.generateReport');
    Route::get('performance/download-report', [App\Http\Controllers\PerformanceController::class, 'downloadPerformanceReport'])->name('performance.downloadReport');
    Route::post('getAllSections', [App\Http\Controllers\PerformanceController::class, 'getAllSections'])->name('performance.getAllSections');
    Route::post('saveSectionContent', [App\Http\Controllers\PerformanceController::class, 'saveSectionContent'])->name('performance.saveSectionContent');
    Route::post('getCompleteAuditReport', [App\Http\Controllers\PerformanceController::class, 'getCompleteAuditReport'])->name('performance.getCompleteAuditReport');
    Route::post('/performance/finalize-complete-report', [App\Http\Controllers\PerformanceController::class, 'finalizeCompleteReport'])->name('performance.finalizeCompleteReport');

    Route::post('/get-findings-recommendations', [App\Http\Controllers\PerformanceController::class, 'getFindingsRecommendations'])->name('performance.getFindingsRecommendations');

    Route::post('get-file-details', [App\Http\Controllers\PerformanceController::class, 'getFileDetails'])->name('Performance.getFileDetails');
    Route::post('get-reportfile-details', [App\Http\Controllers\PerformanceController::class, 'getReportFileDetails'])->name('Performance.getReportFileDetails');
    Route::post('update-file-in-report-flag', [App\Http\Controllers\PerformanceController::class, 'updateFileInReportFlag'])->name('Performance.updateFileInReportFlag');
    Route::post('/performance/remove-section-file', [App\Http\Controllers\PerformanceController::class, 'removeSectionFile'])->name('performance.removeSectionFile');
    Route::post('performance/verifyMemberRemarks', [App\Http\Controllers\PerformanceController::class, 'verifyMemberRemarks'])->name('Performance.verifyMemberRemarks');
    Route::post('performance/processFileActions', [App\Http\Controllers\PerformanceController::class, 'processFileActions'])->name('Performance.processFileActions');
    // ------------------------Performance Report End -----------------------------------------------------------------------------------------------
    Route::get('/api_scheduleuserupdate', function () {
        return view('transactionflow/api_scheduleuserupdate');
    });

    Route::get('/get_api_changeuserdel', [TransactionflowController::class, 'get_api_changeuserdel'])
        ->name('get_api_changeuserdel');

    // routes/web.php

    Route::post('/updateuserdel', [App\Http\Controllers\APIController::class, 'updateuserdel'])
        ->name('updateuserdel');

    Route::post('/legacy/updateleagacy_file', [App\Http\Controllers\LagacyController::class, 'updateleagacy_file']);
    Route::get('/epacsdetails', function () {
        return app()->call('App\Http\Controllers\ReportController@inspectview_dropdown', ['index' => 'report.epacscountanddetails']);
    })->name('idlereport');

    Route::post('/getepacsdetails', [App\Http\Controllers\ReportController::class, 'getepacsdetails'])
        ->name('getepacsdetails');

    Route::post('/fetch_epcsdetails', [App\Http\Controllers\ReportController::class, 'fetch_epcsdetails'])
        ->name('fetch_epcsdetails');

    Route::post('/transaction/get_fromtodeptdet', [TransactionflowController::class, 'get_fromtodeptdet'])->name('transaction.get_fromtodeptdet');

    Route::get('/spilloverdel/{auditplanid}', [FieldAuditController::class, 'getspilloverdel_compact'])
        ->name('spilloverdel')
        ->defaults('viewvalue', 'fieldaudit.spilloverdel');

    Route::post('/getspilloverslipdetails', [App\Http\Controllers\FieldAuditController::class, 'getspilloverslipdetails'])
        ->name('getspilloverslipdetails');

    Route::post('/audit/automateschedule', [App\Http\Controllers\AuditManagementController::class, 'automateschedule'])->name('audit.automateschedule');

    // ------------------------------------------Ready for audit ------------------------------
    Route::get('/readyforaudit', [App\Http\Controllers\AuditManagementController::class, 'getcompactdel_readyforaudit']);

    Route::get('/readyforaudit/regions', [App\Http\Controllers\AuditManagementController::class, 'getReadyForAuditRegions']);

    Route::get('/readyforaudit/districts', [App\Http\Controllers\AuditManagementController::class, 'getReadyForAuditDistricts']);

    Route::get('/readyforaudit/list', [App\Http\Controllers\AuditManagementController::class, 'getInstitutions']);

    Route::post('/readyforaudit/save', [App\Http\Controllers\AuditManagementController::class, 'save']);

    // -------------------------------Ready for audit end ----------------------------------------
    // ------------------------------------------Manual Template Audit Start -----------------------------------------------------------

    Route::get('/manualtemplate', [App\Http\Controllers\TemplateAuditController::class, 'fetch_dept']);
    Route::post('/manualtemplate/getquarter', [App\Http\Controllers\TemplateAuditController::class, 'getQuarterByDept']);
    Route::post('/manualtemplate/getregions', [App\Http\Controllers\TemplateAuditController::class, 'getRegionsByDept']);
    Route::post('/manualtemplate/getdistricts', [App\Http\Controllers\TemplateAuditController::class, 'getDistrictsByRegion']);
    Route::post('/manualtemplate/getcategories', [App\Http\Controllers\TemplateAuditController::class, 'getCategoriesByLocation']);
    Route::post('/manualtemplate/getcategorylimit', [App\Http\Controllers\TemplateAuditController::class, 'getCategoryInstitutionLimit']);
    Route::post('/manualtemplate/getinstitutions', [App\Http\Controllers\TemplateAuditController::class, 'getInstitutionsByFilters']);
    Route::post('/manualtemplate/getauditors', [App\Http\Controllers\TemplateAuditController::class, 'getAuditorsByDeptAndDistrict']);
    Route::post('/manualtemplate/save', [App\Http\Controllers\TemplateAuditController::class, 'saveTempTemplateAuditPlan']);
    Route::post('/manualtemplate/fetch', [App\Http\Controllers\TemplateAuditController::class, 'fetchTempTemplateAuditPlans']);
    Route::post('/manualtemplate/detail', [App\Http\Controllers\TemplateAuditController::class, 'fetchTempTemplateAuditPlanDetail']);
    Route::post('/getcategoriesbasednondept', [App\Http\Controllers\TemplateAuditController::class, 'getCategoriesBasedOnDept']);
    Route::post('/getsubcategory', [App\Http\Controllers\TemplateAuditController::class, 'getSubcategory']);
    ...
    Route::middleware('helpdesk.access')->prefix('helpdesk')->name('helpdesk.')->group(function () {
        ...
        Route::post('/tickets/{ticket}/watchlist', [App\Http\Controllers\HelpdeskTicketController::class, 'watchlist'])->name('tickets.watchlist');
        Route::post('/tickets/{ticket}/watchlist/remove', [App\Http\Controllers\HelpdeskTicketController::class, 'removeWatchlist'])->name('tickets.watchlist.remove');
        ...
        Route::get('/tasks/list', [App\Http\Controllers\DeveloperTaskController::class, 'index'])->name('tasks.list');
        Route::get('/tasks/testing/list', [App\Http\Controllers\DeveloperTaskController::class, 'testingTasks'])->name('tasks.testing.list');
        Route::post('/tasks', [App\Http\Controllers\DeveloperTaskController::class, 'store'])->name('tasks.store');
        Route::get('/tasks/dashboard', [App\Http\Controllers\DeveloperTaskController::class, 'dashboard'])->name('tasks.dashboard');
        Route::get('/tasks/dashboard/data', [App\Http\Controllers\DeveloperTaskController::class, 'dashboardData'])->name('tasks.dashboard.data');
        Route::get('/tasks/{task}', [App\Http\Controllers\DeveloperTaskController::class, 'show'])->whereNumber('task')->name('tasks.show');
        Route::post('/tasks/{task}', [App\Http\Controllers\DeveloperTaskController::class, 'update'])->whereNumber('task')->name('tasks.update');
    });

    Route::middleware(['check.session', 'portal.access'])->prefix('portal')->name('portal.')->group(function () {
        Route::get('/dashboard', [App\Http\Controllers\PortalController::class, 'dashboard'])->name('dashboard');
        Route::get('/dashboard/data', [App\Http\Controllers\PortalController::class, 'dashboardData'])->name('dashboard.data');

        Route::get('/content', [App\Http\Controllers\PortalController::class, 'index'])->name('content.index');
        Route::get('/content/data', [App\Http\Controllers\PortalController::class, 'data'])->name('content.data');
        Route::get('/content/create', [App\Http\Controllers\PortalController::class, 'create'])->name('content.create');
        Route::get('/content/manage', [App\Http\Controllers\PortalController::class, 'manage'])->name('content.manage');
        Route::post('/content', [App\Http\Controllers\PortalController::class, 'store'])->name('content.store');
        Route::get('/content/{id}/edit', [App\Http\Controllers\PortalController::class, 'edit'])->whereNumber('id')->name('content.edit');
        Route::post('/content/{id}', [App\Http\Controllers\PortalController::class, 'update'])->whereNumber('id')->name('content.update');
        Route::post('/content/{id}/submit', [App\Http\Controllers\PortalController::class, 'submit'])->whereNumber('id')->name('content.submit');
        Route::post('/content/{id}/approve', [App\Http\Controllers\PortalController::class, 'approve'])->whereNumber('id')->name('content.approve');
        Route::post('/content/{id}/reject', [App\Http\Controllers\PortalController::class, 'reject'])->whereNumber('id')->name('content.reject');
        Route::post('/content/{id}/toggle-active', [App\Http\Controllers\PortalController::class, 'toggleActive'])->whereNumber('id')->name('content.toggle-active');
        Route::get('/content/{id}/history', [App\Http\Controllers\PortalController::class, 'history'])->whereNumber('id')->name('content.history');
        Route::delete('/content/{id}', [App\Http\Controllers\PortalController::class, 'destroy'])->whereNumber('id')->name('content.destroy');

        Route::get('/users', [App\Http\Controllers\PortalController::class, 'users'])->name('users.index');
        Route::get('/users/data', [App\Http\Controllers\PortalController::class, 'usersData'])->name('users.data');
        Route::post('/users/lookup', [App\Http\Controllers\PortalController::class, 'lookupUser'])->name('users.lookup');
        Route::post('/users', [App\Http\Controllers\PortalController::class, 'assignRole'])->name('users.store');
        Route::post('/users/{id}/toggle', [App\Http\Controllers\PortalController::class, 'toggleUserActive'])->whereNumber('id')->name('users.toggle');
        Route::post('/users/{id}/role', [App\Http\Controllers\PortalController::class, 'changeUserRole'])->whereNumber('id')->name('users.role');
    });


    Route::middleware([\App\Http\Middleware\HelpdeskV2Access::class])
        ->prefix('helpdesk-v2')
        ->name('helpdesk-v2.')
        ->group(function () {
            Route::get('/', [App\Http\Controllers\HelpdeskV2DashboardController::class, 'index'])->name('dashboard.default');
            Route::get('/dashboard-data/{role?}', [App\Http\Controllers\HelpdeskV2DashboardController::class, 'data'])
                ->whereIn('role', ['user', 'state_admin', 'nic_admin', 'layer_lead', 'developer', 'tester', 'watchlist'])
                ->name('dashboard.data');
            Route::get('/dashboard/{role?}', [App\Http\Controllers\HelpdeskV2DashboardController::class, 'index'])
                ->whereIn('role', ['user', 'state_admin', 'nic_admin', 'layer_lead', 'developer', 'tester', 'watchlist'])
                ->name('dashboard');
            Route::get('/taskdetails', [App\Http\Controllers\TaskManagementController::class, 'details'])
                ->name('taskdetails');

            Route::get('/tickets', [App\Http\Controllers\HelpdeskV2TicketController::class, 'index'])->name('tickets.index');
            Route::get('/tickets/create', [App\Http\Controllers\HelpdeskV2TicketController::class, 'create'])->name('tickets.create');
            Route::get('/tickets/plan-details', [App\Http\Controllers\HelpdeskV2TicketController::class, 'planDetails'])->name('tickets.plan-details');
            Route::post('/tickets', [App\Http\Controllers\HelpdeskV2TicketController::class, 'store'])->name('tickets.store');
            Route::put('/tickets/{ticket}', [App\Http\Controllers\HelpdeskV2TicketController::class, 'update'])->whereNumber('ticket')->name('tickets.update');
            Route::get('/tickets/{ticket}', [App\Http\Controllers\HelpdeskV2TicketController::class, 'show'])->whereNumber('ticket')->name('tickets.show');
            Route::post('/tickets/{ticket}/comments', [App\Http\Controllers\HelpdeskV2TicketController::class, 'comment'])->whereNumber('ticket')->name('tickets.comments.store');
            Route::post('/tickets/{ticket}/watchlist', [App\Http\Controllers\HelpdeskV2TicketController::class, 'watchlist'])
                ->whereNumber('ticket')
                ->name('tickets.watchlist');
            Route::post('/tickets/{ticket}/watchlist/remove', [App\Http\Controllers\HelpdeskV2TicketController::class, 'removeWatchlist'])
                ->whereNumber('ticket')
                ->name('tickets.watchlist.remove');
            Route::post('/tickets/{ticket}/developer-comments/{devComment}/forward', [App\Http\Controllers\HelpdeskV2TicketController::class, 'forwardDeveloperComment'])
                ->whereNumber('ticket')
                ->whereNumber('devComment')
                ->name('tickets.dev-comments.forward');
            Route::post('/tickets/{ticket}/actions/{action}', [App\Http\Controllers\HelpdeskV2TicketController::class, 'transition'])
                ->whereNumber('ticket')
                ->where('action', '[A-Za-z0-9_]+')
                ->name('tickets.actions');
            Route::get('/tickets/{ticket}/attachments/{index}/download', [App\Http\Controllers\HelpdeskV2TicketController::class, 'downloadAttachment'])
                ->whereNumber('ticket')
                ->whereNumber('index')
    ...
    Route::middleware([\App\Http\Middleware\HelpdeskV2Access::class])
        ...
        ->group(function () {
            Route::get('/', [App\Http\Controllers\TaskManagementController::class, 'dashboard'])
                ->name('dashboard');
            Route::get('/create', [App\Http\Controllers\TaskManagementController::class, 'create'])
                ->name('create');
            Route::post('/', [App\Http\Controllers\TaskManagementController::class, 'store'])
                ->name('store');
            Route::get('/{task}', [App\Http\Controllers\TaskManagementController::class, 'show'])
                ->whereNumber('task')
                ->name('show');
            Route::post('/{task}/schedule', [App\Http\Controllers\TaskManagementController::class, 'updateSchedule'])
                ->whereNumber('task')
                ->name('schedule');
            Route::post('/{task}/descriptions', [App\Http\Controllers\TaskManagementController::class, 'addDescription'])
                ->whereNumber('task')
                ->name('descriptions.store');
            Route::post('/{task}/complete', [App\Http\Controllers\TaskManagementController::class, 'complete'])
                ->whereNumber('task')
                ->name('complete');
            Route::post('/{task}/verify-testing', [App\Http\Controllers\TaskManagementController::class, 'verifyTesting'])
                ->whereNumber('task')
                ->name('verify-testing');
        });
    ...
    Route::get('/consolidationapproverlist', [App\Http\Controllers\ReportController::class, 'consolidationapproverinstitutionList'])->name('approver.institution.list');
    Route::get('/approver-consolidation-details', [App\Http\Controllers\ReportController::class, 'consolidationApproverParaDetails'])->name('approver.consolidation.details');
    Route::post('/check-all-selected-institutions-paras', [App\Http\Controllers\ReportController::class, 'checkAllSelectedInstitutionsParas']);
    ...
    // });
     Route::post('/checklistplan/chk_dist', [AuditManagementController::class, 'chk_dist'])
        ->name('chk_dist');

		Route::get(
        '/data_verification/{deptcode}/{regioncode}/{distcode}/{quartercode}/{planmappingid}/{prioritycode}',
        [App\Http\Controllers\AuditManagementController::class, 'dataVerification']
    )
        ->name('data.verification')
        ->defaults('viewvalue', 'audit.data_verification');

    Route::get('checklistplan', [
        App\Http\Controllers\AuditManagementController::class,
        'checklist_dropdown'
    ])->name('checklistplan')->defaults('viewName', 'audit.checklistplan');
    ...
    Route::post('/checklistplan/finaliseplan', [AuditManagementController::class, 'finaliseplan'])
        ->name('finaliseplan');
    Route::post('/checklistplan/mark-plan-details-verified', [AuditManagementController::class, 'markChecklistPlanDetailsVerified'])
        ->name('checklistplan.mark_plan_details_verified');
    ...
    Route::post('/instchange/field-loader', [App\Http\Controllers\AuditManagementController::class, 'instchangeFieldLoader'])->name('instchange.fieldloader');
    ...
    Route::get('/verification', [App\Http\Controllers\AuditManagementController::class, 'verificationLanding'])->name('verification.landing');
    // Temporary testing shortcut for data verification.
    Route::get('/data_verification_test', function () {
        return redirect()->route('data.verification', [
            'deptcode' => '02',
            'regioncode' => '27',
            'distcode' => '005',
            'quartercode' => 'Q1',
    ...
    Route::get('/data_verification/{deptcode}/{regioncode}/{distcode}/{quartercode}/{planmappingid}/{prioritycode?}', [App\Http\Controllers\AuditManagementController::class, 'dataVerification'])
        ->defaults('prioritycode', 'null')
        ->name('data.verification');
    Route::post('/data_verification/details', [App\Http\Controllers\AuditManagementController::class, 'dataVerificationDetails'])->name('data.verification.details');
    Route::post('/data_verification/save-draft', [App\Http\Controllers\AuditManagementController::class, 'dataVerificationSaveDraft'])->name('data.verification.save_draft');
    Route::post('/data_verification/pending-transactions', [App\Http\Controllers\AuditManagementController::class, 'dataVerificationPendingTransactions'])->name('data.verification.pending_transactions');
    Route::post('/data_verification/finalize', [App\Http\Controllers\AuditManagementController::class, 'dataVerificationFinalize'])->name('data.verification.finalize');
    Route::post('/data_verification/send-otp', [App\Http\Controllers\AuditManagementController::class, 'SendOTP_DataVerification'])->name('data.verification.send_otp');
    Route::post('/data_verification/verify-otp', [App\Http\Controllers\AuditManagementController::class, 'VerifyOTP_DataVerification'])->name('data.verification.verify_otp');
    ...
    Route::post('/manualplan/getManualSchemeTeamMembers', [App\Http\Controllers\AuditManagementController::class, 'getManualSchemeTeamMembers']);
    ...
    Route::post('/check_leave_schedule_details', [TransactionflowController::class, 'checkShortLeaveScheduleDetails'])->name('leave.check_schedule_details');
...
Route::get('/captcha-text', function () {
    $code ='1';  // Generate a new CAPTCHA code
...
Route::post('/changepasswordfordashboard', [AccountSettings::class, 'dashboard_ChangePassword'])->name('dashboardchangepassword');
...
Route::get('/', function () {
    ...
    $departments = DB::table('audit.mst_dept')
        ...
        ->where('statusflag', 'Y') // Optional
        ->orderBy('orderid')
        ->get();

    return view('site.homepage', compact('departments'));
});

Route::get('/camsgpt/questions', [App\Http\Controllers\HomeController::class, 'camsgptQuestions'])
    ->name('camsgpt.questions');
Route::get('/camsgpt/answer/{id}', [App\Http\Controllers\HomeController::class, 'camsgptAnswer'])
    ->whereNumber('id')
    ->name('camsgpt.answer');


Route::post('/save-grievance', [App\Http\Controllers\HomeController::class, 'saveGrievance'])
    ->name('save.grievance');

Route::post('/grievance/send-otp', [App\Http\Controllers\HomeController::class, 'sendGrievanceOtp'])
    ->name('grievance.send_otp');
Route::post('/grievance/verify-otp', [App\Http\Controllers\HomeController::class, 'verifyGrievanceOtp'])
    ->name('grievance.verify_otp');
Route::post('/grievance/clear-verification', [App\Http\Controllers\HomeController::class, 'clearGrievanceVerification'])
    ->name('grievance.clear_verification');
Route::get('/grievance/status', [App\Http\Controllers\HomeController::class, 'grievanceStatus'])
    ->name('grievance.status');


Route::get('/register-grievance', [App\Http\Controllers\HomeController::class, 'grievanceform_compact'])
    ->name('grievance.register');

Route::get('/grievancelist', [App\Http\Controllers\GrievanceController::class, 'grievancelist'])
    ->name('grievance.list');

Route::get('/grievancelist/data', [App\Http\Controllers\GrievanceController::class, 'getData'])
    ->name('grievance.list.data');

Route::get('/grievance/download/{fileuploadid}', [App\Http\Controllers\GrievanceController::class, 'download'])
    ->name('grievance.download');
